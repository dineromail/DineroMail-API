<%-- 
    Document   : DoPaymentWithCreditCard
...
try {
    ...
    Buyer oBuyer = new Buyer();
     ...
     CreditCard oCard = new CreditCard();
                oCard.setInstallment        ( ccInstallment );
                oCard.setCreditCardNumber   ( ccCreditCardNumber );
                oCard.setDocumentNumber     ( ccDocumentNumber );
                oCard.setHolder             ( ccHolder );
                oCard.setExpirationDate     ( ccExpirationDate );
                oCard.setSecurityCode       ( ccSecurityCode );
                oCard.setAddress            ( ccAddress );
                oCard.setAddressNumber      ( ccAddressNumber );
                oCard.setAddressComplement  ( ccAddressComplement );
                oCard.setZipCode            ( ccZipCode );
                oCard.setNeighborhood       ( ccNeighborhood );
                oCard.setCity               ( ccCity );
                oCard.setState              ( ccState );
                oCard.setCountry            ( ccCountry );
                oCard.setBankId             ( ccBankId );
    ...
    result = port.doPaymentWithCreditCard(    credential
                                            , crypt
